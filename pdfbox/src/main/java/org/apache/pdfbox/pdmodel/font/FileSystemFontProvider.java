...
final class FileSystemFontProvider extends FontProvider
{
    ...
    {
        try (TrueTypeCollection ttc = TrueTypeCollection.createUnbuffered(ttcFile))
        {
     ...
     * Adds an OTF or TTF font to the file cache. To reduce memory, the parsed font is not cached.
     */
    private void addTrueTypeFontImpl(FontHeaders ttf, File file, String fileHash) throws IOException
    {
