 ...
 * it works with the buffer directly.
 * 
 * Performance: it may be slower if whole buffer is read via read() operations,
 * but much faster if most of the buffer is skipped
 *
 * @author Mykola Bohdiuk
 */
class RandomAccessReadUncachedDataStream extends TTFDataStream
{
     ...
     */
    RandomAccessReadUncachedDataStream(RandomAccessRead randomAccessRead) throws IOException
    {
